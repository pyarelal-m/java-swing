...
/*
<applet code="SoundApplet.class" height=500 width=500>
</applet>
*/
public class SoundApplet extends JApplet
    ...
    String auFile = "die.au";
   // String aiffFile = "flute+hrn+mrmba.aif";
    String midiFile = "Paradise.mid";
   // String rmfFile = "jungle.rmf";
    String wavFile = "1adam5.wav";
    String chosenFile;
    ...
    public void init() {
        String [] fileTypes = {auFile,midiFile,wavFile};
